...
window.onload = function () {
  var messagesEl = document.querySelector(".messages-m");
  var typingSpeed = 20;
  ...
  var messages = [
    ...
    "Scroll down to see my <br/> <a href='#rwork'>recent work</a>.<br/> Find out more <a href = 'about.html' > about me</a>.<br/> or get in <a href='mailto:hello@jacob-laird.com'>contact</a>.",
  ];
